  ...
  async function handleSendEmail() {
    ...
    try {
      const res = await fetch("/api/email-pdf", {
        ...
        body: JSON.stringify({ to: emailTo, orderId, type: "statement", customSubject: emailSubject || "", customFrom: emailFrom || "", bankIdx, mailIdx, bankbookIdx: attachBankbook ? bankbookIdx : 0, bizRegIdx: attachBizReg ? bizRegIdx : 0 }),
      });
