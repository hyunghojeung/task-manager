...
export default function EstimatePage() {
  return <Suspense fallback={<div className="p-10 text-center text-gray-400">로딩중...</div>}><EstimateContent /></Suspense>;
}
