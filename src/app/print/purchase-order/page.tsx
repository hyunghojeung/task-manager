          ...
          <tbody>
            {items.map((it, i) => (
              <tr key={i}>
                ...
                <td className="border border-gray-300 px-2 py-2 text-center whitespace-nowrap">{it.spec}</td>
                <td className="border border-gray-300 px-2 py-2 text-center whitespace-nowrap">{it.paper_grain}</td>
                <td className="border border-gray-300 px-2 py-2 text-center whitespace-nowrap">{it.quantity}</td>
                <td className="border border-gray-300 px-2 py-2 text-center whitespace-nowrap">{it.cut_size}</td>
              </tr>
            ))}
