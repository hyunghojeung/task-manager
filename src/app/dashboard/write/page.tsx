        ...
        <table className="w-full border-collapse text-sm"><tbody>
          ...
          <tr>
            <td className="text-[#3b4b5b] font-bold text-xs py-2 px-2 border border-gray-200 align-top">
              작업내용1
              <button type="button" onClick={() => setShowDetailExpand(true)} title="크게 보면서 입력" className="mt-2 w-full px-0 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs font-bold shadow print:hidden leading-tight whitespace-nowrap flex flex-col items-center gap-0.5"><span className="text-lg leading-none">🔍</span><span>확대보기</span></button>
            </td>
            <td colSpan={3} className="py-1.5 px-2 border border-gray-200">
