        ...
        <table className="w-full border-collapse text-sm"><tbody>
          ...
          <tr>
            <td className="text-[#3b4b5b] font-bold text-xs py-2 px-2 border border-gray-200 align-top">
              작업내용1
              <button type="button" onClick={() => setShowDetailExpand(true)} title="크게 보면서 입력" className="mt-2 w-full px-1 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded text-sm font-bold shadow print:hidden leading-tight whitespace-nowrap"><span className="block text-base">🔍</span>확대보기</button>
            </td>
            <td colSpan={3} className="py-1.5 px-2 border border-gray-200">
