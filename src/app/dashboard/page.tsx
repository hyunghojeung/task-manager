      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border border-gray-300 text-xs">
          <thead><tr className="bg-[#3b4b5b] text-white">
            <th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">순번</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">거래처</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">주문자</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">연락처</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">제목</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">금액</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">제품형태</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">결제</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">진행상태</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">거래명세서</th><th className="border border-[#2d3a47] px-2 py-2.5 whitespace-nowrap">견적서</th>
          </tr></thead>
          <tbody>
