          ...
          <tbody>
            ...
            orders.map((o, i) => (
              <tr key={o.id} className={`${i % 2 === 1 ? "bg-gray-50" : ""} hover:bg-blue-50`}>
                <td className="border border-gray-200 px-1.5 py-[7px] text-center">{(page-1)*40+i+1}</td>
                ...
                <td className="border border-gray-200 px-1.5 py-[7px] text-center"><a href={`/dashboard/statement?id=${o.id}`} target="_blank" className="px-2 py-0.5 border border-gray-300 rounded text-xs hover:text-blue-600">명세서</a></td>
                <td className="border border-gray-200 px-1.5 py-[7px] text-center"><a href={`/dashboard/estimate?id=${o.id}`} target="_blank" className="px-2 py-0.5 border border-gray-300 rounded text-xs hover:text-red-600">견적서</a></td>
              </tr>
            ))}
          </tbody>
        </table>
