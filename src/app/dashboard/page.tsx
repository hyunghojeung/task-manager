      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border border-gray-300 text-xs">
          <thead><tr className="bg-[#3b4b5b] text-white">
            <th className="border border-[#2d3a47] px-2 py-2.5">순번</th><th className="border border-[#2d3a47] px-2 py-2.5">거래처</th><th className="border border-[#2d3a47] px-2 py-2.5">주문자</th><th className="border border-[#2d3a47] px-2 py-2.5">연락처</th><th className="border border-[#2d3a47] px-2 py-2.5">제목</th><th className="border border-[#2d3a47] px-2 py-2.5">금액</th><th className="border border-[#2d3a47] px-2 py-2.5">제품형태</th><th className="border border-[#2d3a47] px-2 py-2.5">결제</th><th className="border border-[#2d3a47] px-2 py-2.5">진행상태</th><th className="border border-[#2d3a47] px-2 py-2.5">거래명세서</th><th className="border border-[#2d3a47] px-2 py-2.5">견적서</th>
          </tr></thead>
          <tbody>
